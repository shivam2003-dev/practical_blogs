...
- [Linear Algebra](semester-1/mathematical-foundations/topics/linear-algebra.md) - Systems of linear equations, row reduction, and solution sets
- [System of Two Linear Equations](semester-1/mathematical-foundations/topics/system-two-linear-equations.md) - Solving 2x2 systems with multiple approaches

### 🤖 Machine Learning

- [PCA: fit() and transform()](semester-1/machine-learning/topics/pca-fit-transform.md) - Understanding Principal Component Analysis

---

> 💡 Use the navigation sidebar to explore all topics and sections.
